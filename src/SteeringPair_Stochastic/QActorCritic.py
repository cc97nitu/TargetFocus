...
from SteeringPair import Struct, Network
...
if __name__ == "__main__":
    ...
    # create model
    model = Model(PolicyNetwork=Network.Cat3, QNetwork=Network.FC7)

    # define hyper parameters
    hyperParamsDict = {"BATCH_SIZE": 128, "GAMMA": 0.1, "TARGET_UPDATE": 10, "EPS_START": 0.5, "EPS_END": 0,
    ...
    # show terminations
    _, terminations, _ = trainer.benchAgent(50)
    print(terminations)
