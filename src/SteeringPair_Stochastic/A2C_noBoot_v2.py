...
import SteeringPair_Stochastic.A2C_noBoot
from SteeringPair_Stochastic import Environment, initEnvironment

class Model(SteeringPair_Stochastic.A2C_noBoot.Model):
    """No modifications needed."""
    pass

class Trainer(SteeringPair_Stochastic.A2C_noBoot.Trainer):
...
if __name__ == "__main__":
    ...
    envConfig = {"stateDefinition": "6d-norm", "actionSet": "A9", "rewardFunction": "stochasticPropRewardStepPenalty",
                 ...
                 "stateNoiseAmplitude": 0.1, "rewardNoiseAmplitude": 0.2, "successBounty": 10,
