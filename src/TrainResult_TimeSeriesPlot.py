...
if __name__ == "__main__":
    ...
    # data4A = torch.load("/home/conrad/RL/TempDiff/TargetFocus/src/dump/REINFORCE/6d-states-normalized/6d-norm_4A_RR_Cat1_2000_agents.tar")
    # data9A = torch.load("/home/conrad/RL/TempDiff/TargetFocus/src/dump/REINFORCE/6d-states-normalized/6d-norm_9A_Cat1_2000_agents.tar")
    # data25A = torch.load("/home/conrad/RL/TempDiff/TargetFocus/src/dump/REINFORCE/6d-states-normalized/6d-norm_25A_RR_Cat1_2000_agents.tar")
    #
