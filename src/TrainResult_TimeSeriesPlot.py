...
if __name__ == "__main__":
    # ### train results ###
    # # fetch data
    # data = torch.load("/home/conrad/RL/TempDiff/TargetFocus/src/dump/REINFORCE/6d-states-normalized/propRewardStepPenalty/6d-norm_9A_RR_Cat3_propRewardStepPenalty_2000_agents.tar")
    #
